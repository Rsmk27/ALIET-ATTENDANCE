...
export const Component = ({ scale = 1, className }: { scale?: number, className?: string }) => {
    return (
        <div className={cn("flex items-center justify-center", className)} style={{ transform: `scale(${scale})`, transformOrigin: 'center' }}>
